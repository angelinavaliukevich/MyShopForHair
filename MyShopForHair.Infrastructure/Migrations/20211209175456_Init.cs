    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CriteriaProducts", x => new { x.CriteriasId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_CriteriaProducts_Criterias_CriteriasId",
                        column: x => x.CriteriasId,
                        principalTable: "Criterias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CriteriaProducts_Products_ProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CriteriaProducts_ProductsId",
                table: "CriteriaProducts",
                column: "ProductsId");
